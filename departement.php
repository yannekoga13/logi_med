...
try {
    ...
    if (isset($_GET['search'])) {
        ...
        $stmt = $conn->prepare("SELECT * FROM departements WHERE nom_departement LIKE :search");
        $stmt->execute(['search' => "%$search%"]);
    } else {
        // Requête pour afficher tous les departement
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div
                    ...
                    <h1 class="h2">Départements</h1>
                    <div class="btn-toolbar mb-2 mb-md-0">
                        <div class="btn-group me-2">
                            <a href="adddep.html" class="btn btn-sm btn-outline-secondary">Ajouter un
                                département</a>
                            <a href="deletedepartement.php" class="btn btn-sm btn-outline-secondary">Supprimer un
                                département</a>
                            <a href="consultdepartement.php" class="btn btn-sm btn-outline-secondary">Consulter un département
                            </a>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-6">
                            <form method="GET" action="" class="input-group mb-3">
                                <input type="text" name="search" class="form-control" placeholder="Recherche le departement"
