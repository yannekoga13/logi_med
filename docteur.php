...
try {
    ...
    if (isset($_GET['search'])) {
        ...
        $stmt = $conn->prepare("SELECT * FROM doctors WHERE nom LIKE :search OR prenom LIKE :search");
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div
                    ...
                    <h1 class="h2"  style="font-size: 25px;">Docteurs</h1>
                    <div class="btn-toolbar mb-2 mb-md-0">
                        <div class="btn-group me-2">
                            <a href="adddoctor.html" class="btn btn-sm btn-outline-secondary">Ajouter un
                                docteur</a>
                                <a href="deletedoctor.php" class="btn btn-sm btn-outline-secondary">Supprimer un
                                    docteur</a>
                        </div>
                                    ...
                                    <?php if ($doctors): ?>
                                        <?php foreach ($doctors as $doctor): ?>
                                            <tr>
                                                ...
                                                <td><?= htmlspecialchars($doctor['departement']); ?></td>
                                                <td><?= htmlspecialchars($doctor['date_enregistrement']); ?></td>
                                            </tr>
                                        <?php endforeach; ?>
                                    <?php else: ?>
                                        <tr>
                                            <td colspan="8" class="text-center">Aucun docteurs trouvé</td>
                                        </tr>
                                    <?php endif; ?>
                                </tbody>
                            </table>
