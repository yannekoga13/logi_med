...
try {
    ...
    if (isset($_GET['id'])) {
        ...
        $stmt = $conn->prepare("DELETE * FROM departements WHERE id = :id");
        $stmt->bindParam(':id', $id, PDO::PARAM_INT);
        $stmt->execute();

        // Redirection après suppression
        header('Location: deletedepartement.php?deleted=true');
        exit;
    }

    // Requête pour afficher tous les departements
    $stmt = $conn->query("SELECT * FROM departements");
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div
                    ...
                    <h1 class="h2"  style="font-size: 25px;">Départements</h1>
                    <div class="btn-toolbar mb-2 mb-md-0">
                        <div class="btn-group me-2">
                            <a href="adddep.html" class="btn btn-sm btn-outline-secondary">Ajouter un
                                département</a>
                                <a href="consultdepartement.php" class="btn btn-sm btn-outline-secondary">Consulter un
                                département</a>
                        </div>
                        ...
                        <div class="col-md-6">
                            <form method="GET" action="" class="input-group mb-3">
                                <input type="text" name="search" class="form-control"
                                    placeholder="Recherche du département" aria-label="Rechercher">
                ...
                <div class="container mt-5">
                    ...
                    <?php if (isset($_GET['deleted'])): ?>
                        <div class="alert alert-success">Le département a été supprimé avec succès.</div>
                    <?php endif; ?>
                        ...
                        <tbody>
                            <?php if ($departements): ?>
                                <?php foreach ($departements as $departement): ?>
                                    <tr>
                                        <td><?= htmlspecialchars($departement['nom_departement']); ?></td>
                                        <td><?= htmlspecialchars($departement['service']); ?></td>
                                        <td>
                                            
                                            <a href="deletedepartement.php?id=<?= $departement['id']; ?>"
