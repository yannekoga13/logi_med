...
try {
    ...
    if (isset($_GET['id'])) {
        ...
        header('Location: deletedoctor.php?deleted=true');
        exit;
    }

    // Requête pour afficher tous les médecins
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <div class="container mt-5">
                    ...
                    <?php if (isset($_GET['deleted'])): ?>
                        <div class="alert alert-success">Le docteur a été supprimé avec succès.</div>
                    <?php endif; ?>
