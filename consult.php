...
try {
    ...
    if (isset($_GET['search'])) {
        $search = $_GET['search'];
        // Requête pour rechercher par nom ou prénom
        $stmt = $conn->prepare("SELECT * FROM patients WHERE nom LIKE :search OR prenom LIKE :search");
        $stmt->execute(['search' => "%$search%"]);
    } else {
        // Requête pour afficher tous les patients
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div
                    ...
                    <h1 class="h2" style="font-size: 25px;">Consultation</h1>
                    <div class="btn-toolbar mb-2 mb-md-0">
                        <div class="btn-group me-2">
                            <a href="addpatient.html" class="btn btn-sm btn-outline-secondary">Ajouter un
                                patient</a>
                                <a href="delete.html" class="btn btn-sm btn-outline-secondary">Supprimer un
                                patient</a>
                            <a href="consult.php" class="btn btn-sm btn-outline-secondary">Consulter un
                                patient</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="container my-4" style="position: relative; margin-left:-45px;">
                    <!-- Barre de recherche -->
                    <div class="row justify-content-center">
                        <div class="col-md-6">
                            <form method="GET" action="" class="input-group mb-3">
                                <input type="text" name="search" class="form-control"
                                    placeholder="Rechercher par nom ou prénom" aria-label="Rechercher">
                            ...
                            <?php if ($patients): ?>
                                <?php foreach ($patients as $patient): ?>
                                    ...
                                    <td><?= htmlspecialchars($patient['nom']); ?></td>
                                                ...
                                                <td><?= htmlspecialchars($patient['profession']); ?></td>
                                            
                                        <td>
                                            <a href="consultpatient.php?id=<?= $patient['id']; ?>"
                                                class="btn btn-danger btn-sm">consulter</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            <?php else: ?>
                                <tr>
                                    <td colspan="7" class="text-center">Aucun docteurs trouvé</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
