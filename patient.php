        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div
                    ...
                    <h1 class="h2" style="font-size: 25px;">Patients</h1>
                    <div class="btn-toolbar mb-2 mb-md-0">
                        <div class="btn-group me-2">
                            <a href="addpatient.html" class="btn btn-sm btn-outline-secondary">Ajouter un
                                patient</a>
                                <a href="deletepatient.php" class="btn btn-sm btn-outline-secondary">Supprimer un
                                patient</a>
                                    ...
                                    <?php if ($patients): ?>
                                        <?php foreach ($patients as $patient): ?>
                                            <tr>
                                                ...
                                                <td><?= htmlspecialchars($patient['motif']); ?></td>
