...
try {
    ...
    if (isset($_GET['id'])) {
        ...
        header('Location: deletepatient.php?deleted=true');
        exit;
    }
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <div class="container mt-5">
                    ...
                    <?php if (isset($_GET['deleted'])): ?>
                        <div class="alert alert-success">Le patient a été supprimé avec succès.</div>
                    <?php endif; ?>
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php if ($patients): ?>
                                <?php foreach ($patients as $patient): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <!-- Bouton supprimer -->
                                            <a href="deletepatient.php?id=<?= $patient['id']; ?>"
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="7" class="text-center">Aucun patients trouvé</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
